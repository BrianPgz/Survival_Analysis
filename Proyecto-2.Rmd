...
Por otro lado, para los estadios de la enfermedad en la que se encuentre el paciente, tenemos que el hecho de estar en el estadio 3 representa un riesgo de muerte de 6.406 mayor en comparación a presentarse en el estadio 1 y 2, y drásticamente notamos como el riesgo aumenta al pasar al estadio 4, teniendo un riesgo de casi el doble al pasar del estadio 3, particularmente su valor es 11.580, es decir, el paciente tiene un riesgo muy elevado de muerte al estar en este estadio en comparación con los 3 primeros.


Así mismo, los coeficientes relacionados a las covariables asociadas a los estadios 3 y 4 representan un nivel de significancia del 10% y 5% respectivamente, siendo más representativo el estadio 3 a pesar de lo ya mencionado anteriormente para los pacientes en el estadio 4. 
...
legend(x = "bottomleft", legend = c("SexoM.E4.Hep.EdS", "SexoM.E4.Hep.EdY", "SexoF.E4.Hep.EdS" , "SexoF.E4.Hep.EdY"), lty = c(3,1,3,1), 
       col = c("cornflowerblue","purple", "green","red"), lwd=3)
```
